...
CREATE TABLE IF NOT EXISTS chunks (
  ...
  chunk_type      TEXT NOT NULL CHECK (chunk_type IN ('summary','system','script')),
...
CREATE INDEX IF NOT EXISTS idx_games_niche     ON games(niche);
...
CREATE INDEX IF NOT EXISTS idx_chunks_index        ON chunks(vectorize_index);
